...
//   return (
//     <div className="w-[40vw] border-2 border-pink-500 mx-auto my-20 flex justify-between">
//       <div className="pl-8 text-white font-semibold text-2xl">Powered by</div>
//       <div className="pr-6"><ArrowRight size={48}/></div>
...
//             className="absolute w-full text-2xl sm:text-3xl font-bold text-white whitespace-nowrap"
//           >
//             {messages[index]}
//           </motion.div>
//         </AnimatePresence>
